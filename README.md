...
**Status: paused, not cancelled.** I pivoted this same Pi 5 to a networking project first. The original idea and build log stay below for the record, and I'll pick this back up later.

## Update (2026-09-17): pivoted to a networking project

AI assistant is on hold for now. Reused this same Pi 5 to run Pi-hole and WireGuard instead. New goal and full build log are in **[NETWORKING.md](NETWORKING.md)**. Original idea and build log stay below, unchanged.
...
That's where the AI assistant build stopped and the networking pivot took over. Full build log for that is in **[NETWORKING.md](NETWORKING.md)**.
